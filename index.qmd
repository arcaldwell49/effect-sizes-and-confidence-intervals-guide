...
When two groups differ substantially in their standard deviations, we can instead standardize by the reference (i.e., control) group standard deviation, such that,

$$
d_{\Delta} = \frac{M_{\text{treatment}}-M_{\text{control}}}{S_{\text{control}}}.
$$

This formulation is commonly referred to as Glass' $\Delta$ [@glass1981]. The standard error for $d_{\Delta}$ can be defined as,

$$
SE_{d_{\Delta}} = \sqrt{\frac{n_1+n_2}{2n_1n_2}+\frac{d^2_{\Delta}}{2(n-1)}}
$$
...
# Treatment Mean = 21.4, SD = 19.59, N = 96
