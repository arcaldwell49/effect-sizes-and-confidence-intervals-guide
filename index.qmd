...
Eta-squared is the ratio between the between-group variance and the total variance. It describes the proportion of the total variability in the data that are accounted for by a particular factor. Therefore, it is a measure of variance explained. In the case of one-way between-subject fixed-effect ANOVA,
...
# ANOVA
mdl <- aov(data = penguins,    # use penguin data set
           body_mass_g ~ species)   # left side indicates outcome, right side indicates grouping
